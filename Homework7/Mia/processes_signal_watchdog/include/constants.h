...
#define PROCESS_SLEEPS_US {100000, 250000, 1000000} /* time each child process sleeps */
#define PROCESS_SIGNAL_INTERVAL 11 /* number of process cycles before signaling watchdog */
#define WATCHDOG_SLEEP_US 100000 /* watchdog sleep interval */
