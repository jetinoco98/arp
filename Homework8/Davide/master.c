...
int main(int argc, char *argv[]) {
    ...
    m_pipe(server_reader1);
    m_pipe(reader1_server);

    m_pipe(server_reader2);
    m_pipe(reader2_server);

    m_pipe(server_writer1);
    m_pipe(writer1_server);

    m_pipe(server_writer2);
    m_pipe(writer2_server);
